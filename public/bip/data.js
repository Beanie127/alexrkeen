...
export const teachers = [
  ...
  },
  {
    ...
    workshopId: [`hosting`],
    pic: ``,
    bio: `Eji is the founder of <em>ImproQuo</em> and a long-time performing artist. He has years of experience in comedy improvisation, including performing in shows, coaching teams, and directing and running live improv productions.</p>
<p>He has also appeared as a regular on BBC Radio Manchester, hosted the main stage at the Festival of Manchester and performed stand-up throughout England.`,
  },
  {
    id: `yiovi`,
    name: "Yiovi",
