export default [
	...
	{
		text: 'Everything I do references something that influenced me.',
		author: 'Virgil Abloh',
	},
	{
		text: "I don't burden my memory with … facts that I can easily find in any textbook.",
		author: 'Albert Einstein',
	},
	{
		text: 'The essential element in the black art of obscurantism is not that it wants to darken individual understanding, but that it wants to blacken our picture of the world, and darken our idea of existence',
		author: 'Friedrich Nietzsche',
		source: 'Human, All Too Human',
	},
	{
		text: 'Agency and introspection are closely entwined—they are the external and internal version of the same thing. A kind of perceptiveness. A capacity to see what is going on, accept it, and chart an effective path in the most interesting direction.',
		author: 'Henrik Karlsson',
		url: 'https://www.henrikkarlsson.xyz/p/thoughts-on-agency',
		source: 'Thoughts on agency | Escaping Flatland',
	},
	{
		text: "I write for two reasons, which are, in order: to work out my own thinking, and; to influence other peoples' thinking. Writing is a cognitive prosthesis for me. Working things out on the page helps me work things out in my life. And, of course, working things out on the page helps me work more things out on the page. Writing begets writing.",
		author: 'Cory Doctorow',
		url: 'https://pluralistic.net/2024/12/21/blockheads-r-us/',
		source: 'Blockheads R Us | Pluralistic',
	},
	{
		text: 'In the midst of winter, I found there was, within me, an invincible summer.',
		author: 'Albert Camus',
		source: "Return to Tipasa | L'été",
	},
	{
	...
	},
	{
		...
		author: 'W.H. Auden',
		source: 'Shorts II | Collected Poems',
	},
	{
	...
	},
	{
		...
		source: 'The Failure of Risk Management: Why Its Broken and How to Fix It',
	},
	{ text: 'It never gets easier, you just go faster.', author: 'Greg LeMond' },
	{
		...
		author: 'Rob Horning',
		url: 'https://robhorning.substack.com/p/artificial-intentionality',
		source: 'Artificial Intentionality | Internal exile',
	},
	{
	...
	},
	{
		...
		url: 'https://therumpus.net/2011/04/21/dear-sugar-the-rumpus-advice-column-71-the-ghost-ship-that-didnt-carry-us/',
		source: "The Ghost Ship That Didn't Carry Us | Dear Sugar",
	},
	{
	...
	},
	{
		...
		source: 'Les Éleuthéromanes | Poèsies Diverses',
	},
	{
		author: 'Clive James',
		text: 'All I can do is turn a phrase until it catches the light... Everything I say is obvious, although I like to think that some of the obvious things I have said were not so obvious until I said them.',
	...
	},
	{
		...
		source: "When Intentions Don't Matter",
		url: 'https://www.wsj.com/articles/when-intentions-dont-matter-11615571956',
	},
	{
		author: 'Plutarch',
	...
	},
	{
		...
		source: 'Radically Condensed Instructions for Being Just as You Are',
	},
	{
		author: 'Paulo Coelho',
	...
	},
	{
		...
		source: 'Perfectly Reasonable Deviations from the Beaten Track',
	},
	{
		author: 'Ursula K. Le Guin',
	...
	},
	{
		...
		text: `What is true is already so.<br/>
      ...
      for they are already enduring it.<br/>`,
		source: 'The Litany of Gendlin',
		url: 'https://www.lesswrong.com/w/litany-of-gendlin',
		category: 'poem',
	},
	{
		author: 'Eliezer Yudkowsky',
		text: `If X, I desire to believe that X.<br/>
      If not X, I desire to believe that not X.<br/>
      Let me not become attached to beliefs I may not want.`,
		source: 'Litany of Tarski',
		url: 'https://www.lesswrong.com/w/litany-of-tarski',
		category: 'poem',
	},
	{
		author: 'AntagonizedPenguin',
		text: 'We live in the world that exists. The best we can do for the world we want to live in is build it.',
		url: 'https://archiveofourown.org/works/4936777/chapters/130645315',
		source:
			"Knowing What's Possible and What Isn't Is Important In Work and Personal Relationships | If The Chosen One Can&apos;t Defy Heteronormative Structures, Who Can? (Lee)",
	},
	{
		author: 'Oscar Wilde',
		...
		source: 'The Sould of Man Under Socialism',
	},
	{
	...
	},
	{
		...
		source: 'The Catcher in the Rye (Holden Caulfield)',
	},
	{
		author: 'Chris Cleave',
